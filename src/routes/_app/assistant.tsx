          ...
          <button
            onClick={async () => {
              ...
              try {
                if (typeof playStudioClick === 'function') playStudioClick("start");
                setLoading(true);
                const carouselPrompt = "Генерирай ми TikTok карусел на силна ислямска тема. ВАЖНО: 1) Провери предишните съобщения и избери НАПЪЛНО НОВА ТЕМА, която НЕ Е била генерирана досега в този чат! 2) ЗАДЪЛЖИТЕЛНО се увери, че всичко (текст, хадиси, цитати) е строго в съответствие със Салафитското учение (Ахлу Сунна уал Джама'а, според разбирането на Салафите) без никакви нововъведения (бид'а) и слаби хадиси.  ЗАДкЛЖИТЕЛН� взимай Аятите и Хадисите САМ� от Quran.com и Sunnah.com, и ги превеждай директно от арабски на български език! ЗАДкЛЖИТЕЛН� взимай Аятите и Хадисите САМ� от Quran.com и Sunnah.com, и ги превеждай от арабски на български език директно! Избери тема свързана с Таухид (Единобожието), величието на Аллах, историите на пророците, чудесата в Корана или смисъла на живота. Избягвай депресиращи теми и стрес. Използвай типа 'carousel'.";
