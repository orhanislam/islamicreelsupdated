...
- explanation: Дълбоко, прецизно разяснение на Тефсира СПОРЕД ТЕМАТА на аята или хадиса, основано на признатите велики салафитски учени:
  ...
  * ВИНАГИ споменавай името на салафитския учен в разяснението (напр. "Шейх ас-Са'ди (рахимахуллах) пояснява в своя Тефсир, че..." или "Ибн Кесир (рахимахуллах) обяснява, че..." или "Ибн ал-Каййим (рахимахуллах) казва...").
  * Дължина: 30-50 думи. СТРИКТНО БЕЗ ТОЧКИ И НОМЕРАЦИЯ, започва директно като "Поука: [текст]".
...
Върни валиден JSON със следната структура:
{
  ...
  "proposal": {
    ...
    "scriptWorkflow": {
      ...
      "explanation": "Шейх Абдур-Рахман ас-Са'ди (рахимахуллах) пояснява в своя Тефсир, че сърцето не може да намери истински покой, сигурност и наслада в нищо земно, освен чрез споменаването на Аллах, обичта към Него и отдаването единствено на Него.",
    ...
    "summaryBg": "Шейх ас-Са'ди (рахимахуллах) пояснява, че сърцето намира истински покой и спасение единствено в споменаването на Аллах и Таухида.",
...
Върни САМО валиден JSON без маркдаун кавички.`;
    ...
    if (parsed.proposal && !parsed.proposal.scriptWorkflow) {
      parsed.proposal.scriptWorkflow = {
        ...
        explanation: parsed.proposal.summaryBg || "Шейх ас-Са'ди (рахимахуллах) пояснява в своя Тефсир, че истинският покой на душата се постига единствено чрез помнене на Аллах, спазване на Таухида и следване на Сунната.",
...
Върни JSON със следната структура:
{
  ...
  "proposal": {
    ...
    "scriptWorkflow": {
      ...
      "explanation": "Шейх ас-Са'ди (рахимахуллах) или Ибн Кесир (рахимахуллах) пояснява в своя Тефсир според темата, че... (30-50 думи)",
