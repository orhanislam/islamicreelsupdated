...
АБСОЛЮТНО ЗАБРАНЕНО е присъствието на хора (people), човешки лица (faces), мъже, жени (woman, man) или животни. Спазвай стриктни Salafi Halal принципи (no animate beings).
...
SALAFI HALAL ПРИНЦИПИ: Когато генерираш "searchQuery", търси САМО природа, абстрактни фонове или ислямска архитектура. СТРИКТНО ЗАБРАНЕНО е да има хора (people), лица (faces), животни или одушевени същества.
