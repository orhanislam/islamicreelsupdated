...
Върни JSON със следната структура:
{
  ...
  "proposal": {
    ...
    "scriptWorkflow": {
      ...
      "explanation": "Шейх ас-Са'ди (рахимахуллах) пояснява в своя Тефсир според темата, че истинският покой се постига единствено чрез таухид и помненето на Аллах Всевишния.",
