...
import { getAiMemory, updateAiMemory, readAiMemory, recordProposalUsages, recordProposalUsagesDirect } from "./memory.functions";
...
import {
  ...
  getVerifiedHadithCatalogPrompt,
...
export type ExplainedVideoScript = {
  ...
  explanation: string;  // 3. Разяснение / Поука / Тефсир (задълбочено обяснение на смисъла)
  actionStep?: string;  // 4. (Опционално за описание/социален пост) Практическо действие или дуа
...
export function cleanProposalTitle(rawTitle: string): string {
  ...
  // 6. Strip repeated dashes/stripes (e.g. --------------------------- or ━━━━━━━━━━━━━━━━)
  title = title.replace(/[-–—_━═─]{2,}/g, " ").trim();

  // 7. Replace standalone dashes used as separators (e.g. " - ", " — ", " – ") with clean bullet " • "
  title = title.replace(/\s+[-–—]+\s+/g, " • ").trim();

  // 8. Clean dangling leading or trailing punctuation
  title = title
    .replace(/^[:\-–—•_━═─\s]+/, "")
    .replace(/[:\-–—•_━═─\s]+$/, "")
    .trim();

  // 9. Normalize multi-spaces
...
Целият текст, който генерираш — съвети, коментари, куки, призиви за действие, разяснения — звучи с дълбоко БЛАГОГОВЕНИЕ (хушу), УБЕДЕНОСТ, АВТОРИТЕТ, ИСКРЕНОСТ (Ихлас), БАЩИНСКА ГРИЖА и ОФИЦИАЛНО, ПРОФЕСИОНАЛНО И УВАЖИТЕЛНО отношение към потребителя, базирани ЕДИНСТВЕНО на Корана и Сунната по разбирането на Салафите. Говори директно към сърцето със сериозен, мъдър и учтив тон, разбираемо за обикновените хора. Избягвай всякакви суфийски, ашари, бид'а или модернистки изрази.

СТРИКТНО ПРАВИЛО ЗА УЧТИВ, ОФИЦИАЛЕН И ПРОФЕСИОНАЛЕН ЕЗИК И ГРАМАТИЧЕСКА СЪГЛАСУВАНОСТ НА МЕСТОИМЕНИЯТА:
1. Към потребителя в чата и призивите се обръщай ВИНАГИ с уважителна, официална и учтива форма: „Вие“, „Вас“, „Ви“, „Вашият / Вашия“, „Вашата“, „Вашето“, „Вашите“.
2. СТРИКТНО СЪГЛАСУВАЙ РОДА НА МЕСТОИМЕНИЯТА В БЪЛГАРСКИЯ ЕЗИК (КАТЕГОРИЧНО СА ЗАБРАНЕНИ МАШИННИ ГРЕШКИ КАТО „вашето Господ“):
   - За думи от МЪЖКИ РОД (Господ, Господар, Творец, Създател, живот, път, иман, сабр, грях, намаз, план, клип): ВИНАГИ „Вашия / Вашият“ (НИКОГА „вашето Господ“, „вашето Творец“, „вашето живот“)!
   - За думи от ЖЕНСКИ РОД (душа, вяра, молитва, дуа, надежда, милост, прошка, скръб): ВИНАГИ „Вашата“ (НИКОГА „вашето душа“, „вашия молитва“)!
   - За думи от СРЕДЕН РОД (сърце, дело, добро, спасение, одобрение, съдържание): „Вашето“ (напр. „Вашето сърце“, „Вашето спасение“)!
   - За думи в МНОЖЕСТВЕНО ЧИСЛО (дела, грехове, стъпки, молитви, въпроси, видеа, предложения): ВИНАГИ „Вашите“ (НИКОГА „вашето дела“, „вашия грехове“)!
3. В чат съобщенията („reply“) общувай авторитетно, учтиво и доброжелателно: „Предлагам Ви...“, „Подбрах за Вас...“, „Можете веднага да одобрите...“, „Следете напредъка...“.
...
3. Когато говориш за Аллах, ВИНАГИ използвай Неговите възвишени и достойни имена: „Аллах Всевишният“, „Единственият Творец“, „Вашият Създател“, „Господарят на световете“, „Всемилостивият“, „Единственият, достоен за обожание“.
...
ПРАВИЛО ЗА УВАЖИТЕЛНИ, ОФИЦИАЛНИ И ПРОФЕСИОНАЛНИ ЕМОДЖИТА:
Разрешени са САМО 100% уважителни, сериозни и официални ислямски емоджита: 📖, 📜, 🕌, 🌿, 💎, 🤍, ✨, 📌, 📋, 🎬, 📊, ⏳, 🔄, 💬, 🛡️, ✅, ❌.
КАТЕГОРИЧНО И СТРОГО ЗАБРАНЕНИ СА НЕУВАЖИТЕЛНИ, СВЕТСКИ, ДЕТСКИ ИЛИ НЕИСЛЯМСКИ ЕМОДЖИТА:
- ⚡ (мълния / светкавица — недопустима аркадна анимация!)
- 🔥 (огън / пламък — светски сленг и асоциация с Джехеннем!)
- 🚀 (ракета — светски крипто/хайп жаргон!)
- 💡 (електрическа крушка — комиксова/анимационна карикатура!)
- Емоджита с човешки ръце и пози (🤲, 👉, 👆, ✍️, 👏, 🤝, 🙏 — забранени!)
- Музикални ноти (🎶, 🎵, 🎼 — забранени!)
- Кааба като декоративна икона (🕋 — забранено!)
В навигационни слайдове използвай изчистена стрелка „-->“.
...
СТРИКТНО ПРАВИЛО ЗА САХИХ ХАДИСИ (НУЛЕВА ТОЛЕРАНТНОСТ КЪМ ГРЕШНИ НОМЕРА):
Когато предлагаш хадис или включваш хадис в предложение (proposal), ТРЯБВА ДА ИЗПОЛЗВАШ ЕДИНСТВЕНО ХАДИС ОТ СПИСЪКА С ГАРАНТИРАНО ВЕРИФИЦИРАНИ ХАДИСИ ПО-ГОРЕ!
ИЗПОЛЗВАЙ ТОЧНАТА МУ КОЛЕКЦИЯ И ТОЧНИЯ МУ НОМЕР от списъка! СТРИКТНО Е ЗАБРАНЕНО ДА ИЗМИСЛЯШ ДРУГИ НОМЕРА НА ХАДИСИ, за да няма абсолютно никакво объркване или несъответствие в сборниците!
...
ИСЛЯМСКО ВИДЕО С ОБЯСНЕНИЕ (ISLAMIC VIDEO WITH EXPLANATION) — СПЕЦИАЛЕН 3-СТЕПЕНЕН WORKFLOW:
...
2. В title ЗАДЪЛЖИТЕЛНО сложи точна референция с ДВОЕТОЧИЕ, последвана от силна и въздействаща ТЕМА на български, напр. "[Коран 13:28] Покоят на сърцата" или "[Сахих ал-Бухари #5645] Скритата милост в изпитанията". (НИКОГА не използвай долна черта в заглавието, само двоеточие!).
...
ВЪВ ВИДЕОТО СЕ ИЗПОЛЗВА СТРИКТНО 3-СТЕПЕННА СТРУКТУРА:
1. Кука (Въпрос + Контекст)
2. Далил (Свещен аят или хадис + изричане на референцията)
3. Обяснение (Задълбочено разяснение на смисъла и мъдростта)
СТРИКТНО ПРАВИЛО: Във видеото НЯМА стъпка „Действие“! Видеото завършва с пълно, ясно и въздействащо Обяснение на смисъла („там да се обяснява това, което трябва“), разясняващо точно това, което е необходимо според Таухида и Сунната!
3. ЗАДЪЛЖИТЕЛНО включи "scriptWorkflow" с изчистена структура (СТРИКТНО БЕЗ МНОГОТОЧИЯ '...', '....', БЕЗ НОМЕРАЦИЯ '1.', '2.', '3.', БЕЗ БУЛЕТИ, БЕЗ 'казва ни се за...'):
   ...
   - "dalilText": Автентичният текст на аята или хадиса на български език В КАВИЧКИ. ВАЖНО ЗА НЕПОЗНАТИ КОРАНИЧЕСКИ ПРОЗВИЩА: Когато в текста се споменава кораническо прозвище или епитет (напр. „Дху-н-Нун“, „Сахиб ал-Хут“, „Дху-л-Карнайн“, „Ал-Хадир“), ЗАДЪЛЖИТЕЛНО веднага след него сложи в кавички какво означава, напр.: „Дху-н-Нун „човекът на кита — пророкът Юнус““, за да разберат обикновените зрители за кого става въпрос!
   - "explanation": ЗАДЪЛБОЧЕНО ОБЯСНЕНИЕ НА СМИСЪЛА СПОРЕД ТЕМАТА (35-60 думи). Разясни точно и въздействащо това, което трябва — смисъла, същината и поуката от далила за вярващия. Във видеото ЗАДЪЛЖИТЕЛНО се изписва и изговаря просто "Обяснение: [чист текст]", КАТО СТРИКТНО НЕ СЕ СПОМЕНАВА ОТ КОГО Е ОБЯСНЕНИЕТО (НИКОГА не пиши "Salafi Shaykh AI пояснява, че...", "Шейх ас-Са'ди пояснява...", "Шейх ал-Усеймин...", "Поука:"). Напиши чисто, достъпно и задълбочено обяснение на смисъла, започващо директно със същината на разяснението или като "Обяснение: [текст]". СТРИКТНО БЕЗ ТОЧКИ И НОМЕРАЦИЯ.
   - "actionStep": Опционално (по желание за социално описание, но във видеото НЕ се изговаря и не се включва).
4. В summaryBg напиши краткото чисто обяснение (35-60 думи) без точки и номерация, без цитиране на имена на шейхове или AI.
...
ВАЖНО: Върни САМО валиден JSON. ОТГОВОРЪТ ТИ ТРЯБВА ДА ЗАПОЧВА ДИРЕКТНО СЪС ЗНАКА { И ДА ЗАВЪРШВА С }. НЕ ПИШИ НИКАКЪВ ДРУГ ТЕКСТ ПРЕДИ ИЛИ СЛЕД JSON ОБЕКТА.`;
    ...
    const replyObj = {
      reply: sanitizeTheologicalRespect(parsed.reply || "С какво мога да Ви помогна днес?"),
...
СТРИКТНО ПРАВИЛО ЗА ХАДИСИ: Ако избираш хадис, ЗАДЪЛЖИТЕЛНО го избери САМО от горния списък с верифицирани хадиси с неговия точен номер и колекция! НИКОГА не измисляй други номера!
...
Върни САМО валиден JSON.`;
  ...
  try {
    ...
    parsed = {
      reply:
        "Предлагам Ви дълбок, рядко цитиран урок от Сахих ал-Бухари за вътрешната сила при изпитания.",
      proposal: {
...
export async function generateExplainedVideoProposalDirect(data?: { topic?: string }): Promise<{
  reply: string;
  proposal: VideoProposal | null;
}> {
  const memory = await readAiMemory();
    ...
    if (detected.type === "quran" && detected.surah && detected.ayah) {
      ...
      const candidateSharhs = [
        ...
        { collection: "bukhari", number: 6412, title: "Сахих ал-Бухари #6412 (Две блага - здраве и свободно време)" },
...
ТВОЯТА РОЛЯ И ГЛАС: Говори с дълбоко благоговение (хушу), бащинска мъдрост, авторитет и непоклатима искреност (Ихлас), базирани САМО на Корана и Сунната по разбирането на Салафите. Говори по официален, уважителен и напълно разбираем начин за обикновените хора.

СТРИКТНО ПРАВИЛО ЗА УЧТИВ, ОФИЦИАЛЕН И ПРОФЕСИОНАЛЕН ЕЗИК И СЪГЛАСУВАНЕ НА МЕСТОИМЕНИЯТА:
1. Говори официално, почтително и професионално с учтива форма: „Вие“, „Вас“, „Ви“, „Вашият / Вашия“, „Вашата“, „Вашето“, „Вашите“.
2. СТРИКТНО СПАЗВАЙ РОДА (КАТЕГОРИЧНО Е ЗАБРАНЕНО „вашето Господ“): За думи от мъжки род (Господ, Творец, Създател, живот, път, грях, намаз) използвай САМО „Вашия / Вашият“! За женски род (душа, вяра, молитва, дуа) използвай „Вашата“. За среден род (сърце, дело, спасение) използвай „Вашето“. За множествено число (дела, грехове, стъпки) използвай „Вашите“.

СТРИКТНО ПРАВИЛО ЗА ТАУХИД, БОГОСЛОВСКА ПРЕЦИЗНОСТ И АДАБ КЪМ АЛЛАХ ВСЕВИШНИЯТ:
1. За Единобожието и Единствеността на Аллах ВИНАГИ използвай „Единственият Творец“!
2. КАТЕГОРИЧНО И СТРОГО Е ЗАБРАНЕНО да използваш умалителни, диалектни или грешни машинизирани форми като „единичък“, „единичкият“, „единичният“ или „единичен Творец“! Думата „единичкият“ е умалителна, погрешна и абсолютно недопустима за Величието на Твореца!
3. Когато говориш за Аллах, ВИНАГИ използвай Неговите възвишени и достойни имена: „Аллах Всевишният“, „Единственият Творец“, „Вашият Създател“, „Господът на световете“, „Всемилостивият“, „Единственият, достоен за обожание“.
...
ЕМОДЖИТА: Разрешени САМО официални и уважителни ислямски символи: 📖, 📜, 🕌, 🌿, 💎, 🤍, ✨, 📌, 📋, 🎬, 📊, ⏳, 🔄, 💬, 🛡️, ✅, ❌ и "-->". СТРОГО ЗАБРАНЕНИ: ⚡, 🔥, 🚀, 💡, ръце (🤲, 👉, 👆, ✍️, 👏, 🤝, 🙏), музикални ноти (🎶, 🎵, 🎼), Кааба (🕋).
...
- dalilText: Самият текст на аята или хадиса на чист български език в кавички. СТРИКТНО ПРАВИЛО ЗА НЕПОЗНАТИ КОРАНИЧЕСКИ ПРОЗВИЩА В КАВИЧКИ: Ако в аята или хадиса се среща кораническо прозвище или епитет (напр. „Дху-н-Нун“, „Сахиб ал-Хут“, „Дху-л-Карнайн“, „Ал-Хадир“), ЗАДЪЛЖИТЕЛНО веднага след него сложи в кавички неговото значение, напр. „Дху-н-Нун „човекът на кита — пророкът Юнус““, за да бъде веднага ясно на обикновените зрители за кого се говори!

ПОУКА И ТЕФСИР (ЧИСТО ОБЯСНЕНИЕ БЕЗ СПОМЕНАВАНЕ НА АВТОР ВЪВ ВИДЕОТО):
- explanation: Дълбоко, прецизно разяснение на смисъла и мъдростта СПОРЕД ТЕМАТА на аята или хадиса (35-60 думи). Разясни точно и ясно това, което трябва:
  ...
  * Дължина: 35-60 думи. СТРИКТНО БЕЗ МНОГОТОЧИЯ И НОМЕРАЦИЯ.
  * СТРОГО ЗАБРАНЕНИ са общи житейски съвети или свободно съчинение — единствено автентично съдържание по Таухид и Сунна!
- СТРИКТНО ПРАВИЛО ЗА ВИДЕОТО: Във видеото НЯМА стъпка „Действие“! Цялото внимание на видеото е фокусирано върху автентичното Обяснение на смисъла.
- actionStep: Опционално, ако има допълнителен съвет за текстовото описание на поста (напр. "Дуа: [текст]"), но във видеото НЕ се изговаря и показва.
...
Върни САМО валиден JSON без маркдаун кавички.`;
    ...
    try {
      ...
      parsed = {
        reply: `Предлагам Ви благороден цитат: ${fallbackTitle} с автентично разяснение от Шейх AI.`,
        proposal: {
          title: fallbackTitle,
          type: "explained_video",
    ...
    if (parsed.proposal) {
      ...
      await recordProposalUsagesDirect([parsed.proposal]).catch(() => {});
    }
...
export const suggestExplainedVideoProposal = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    return generateExplainedVideoProposalDirect(data);
  });
...
Върни САМО валиден JSON без маркдаун обвивки.`;
    ...
    try {
      ...
      parsed = {
        reply: "Предлагам Ви този благороден хадис от Сахих ал-Бухари за искреното търпение и упование в Аллах Всевишният.",
        proposal: {
          title: "[Сахих ал-Бухари #5645] Скритата милост в изпитанията",
          type: "explained_video",
          collection: "bukhari",
    ...
    return {
      reply: sanitizeTheologicalRespect(parsed.reply || "Предлагам Ви това ново алтернативно видео:"),
      proposal: parsed.proposal ? sanitizeProposalFields(parsed.proposal as VideoProposal) : null,
    };
  });
...
2. СТРИКТНО ПРАВИЛО ЗА ХАДИСИ: Ако предложението е от тип 'hadith', ЗАДЪЛЖИТЕЛНО избери хадис САМО от горния проверен каталог на базата данни! КАТЕГОРИЧНО Е ЗАБРАНЕНО да посочваш хадис или номер извън този каталог!
3. ИЗРИЧНО ЗАБРАНЕНО Е да включваш най-популярните текстове като Сура Ал-Бакара 2:255, Сура Ад-Духа (93) или Сура Юсуф! Искаме рядко цитирани, дълбоки и неклиширани текстове.${targetType === "carousel" ? "\nИЗКЛЮЧИТЕЛНО ВАЖНО ЗА КАРУСЕЛ: ЗАДЪЛЖИТЕЛНО генерирай ВСИЧКИ предложения като тип КАРУСЕЛ (type: 'carousel') с 'carouselSlides' от ТОЧНО 4 слайда по Viral Framework (Слайд 1: Hook с curiosity gap/въпрос, Слайдове 2-3: сбит текст с клифхенгъри и автентичен Далил, Слайд 4: стойностен CTA със 'Запази'/'Сподели')!" : ""}
4. ОГРАНИЧЕНИЕ ЗА ВРЕМЕТРАЕНЕ (< 60 секунди): За да се събере във вайръл формат (TikTok/Reels), текстът на български НЕ ТРЯБВА да надвишава 70-80 думи. Ако текстът е дълъг, вземи само част от него! Видеото задължително трябва да е под 1 минута.
5. Задължително включвай кинематографични настройки: "useBRoll": true, "bRollInterval": 5 и "quality": "high".
6. ВИНАГИ включвай точния източник в 'title' на български език във формат: [Коран {surah}:{ayah}] Заглавие или [Сахих {collection} #{number}] Заглавие. СТРИКТНО ЗАБРАНЕНО Е да добавяш '[tiktok carousels]', '[tiktok]' или подобни мета префикси.
7. ПРАВИЛО ЗА ОБЯСНЕНИЕТО (summaryBg): Напиши директно, красиво и дълбоко богословско обяснение на ислямската поука (30-50 думи) на чист, естествен български език. СТРИКТНО ЗАБРАНЕНО Е да пишеш мета-подкани като 'Разбери психологическите причини...', 'Научи най-важния урок...', 'В това видео ще разгледаме...'. Напиши самото разяснение и духовна мъдрост по същество!
8. ПРАВИЛО ЗА БЕКГРАУНД ВИДЕО (searchQuery): ЗАБРАНЕНО Е ДА ИМА ХОРА (мъже или жени) във видеата! Твоят searchQuery трябва ВИНАГИ да бъде само за природа, пейзажи и абстрактни неща (напр. "nature landscape mountain sunset peaceful no people"). Никога не включвай думи като "person", "woman", "man", "people".
...
{
  "reply": "Подбрах за Вас специален пакет от ${countNum} силни ислямски теми с автентични цитати и поуки. Всяка идея адресира важен житейски въпрос за сърцето и вярата. Моля, отбележете кои желаете да одобрите за генериране:",
  "proposals": [
    {
      ...
      "ayah": 255,
      "count": 1,
      "summaryBg": "Аят ал-Курси разкрива абсолютната мощ и господство на Аллах Всевишния, Когото нито дрямка, нито сън Го обзема, вдъхвайки непоклатима защита и мир в душата.",
    ...
    },
    {
      ...
      "collection": "bukhari",
      "number": 5645,
      "summaryBg": "Изпитанията не са знак за изоставяне, а скрита милост от Твореца. Когато Аллах желае добро за Свой раб, Той го пречиства от греховете чрез житейски трудности, за да въздигне степента му в Дженнета.",
...
export function sanitizeProposalFields(p: VideoProposal): VideoProposal {
  ...
  if (p.carouselSlides && Array.isArray(p.carouselSlides)) {
    for (const s of p.carouselSlides) {
      if (s.topTitle) s.topTitle = sanitizeTheologicalRespect(enrichUnfamiliarQuranicTerms(s.topTitle));
      if (s.mainText) s.mainText = sanitizeTheologicalRespect(enrichUnfamiliarQuranicTerms(s.mainText));
      if (s.bottomText) s.bottomText = sanitizeTheologicalRespect(enrichUnfamiliarQuranicTerms(s.bottomText));
      if (s.footerText) s.footerText = sanitizeTheologicalRespect(enrichUnfamiliarQuranicTerms(s.footerText));
      if (s.quoteText) s.quoteText = sanitizeTheologicalRespect(enrichUnfamiliarQuranicTerms(s.quoteText));
      if (s.commentaryText) s.commentaryText = sanitizeTheologicalRespect(enrichUnfamiliarQuranicTerms(s.commentaryText));
      if (s.sourceBadge) s.sourceBadge = sanitizeTheologicalRespect(s.sourceBadge);
    }
  }
  return p;
}
...
export function buildExplainedNarrationText(params: {
  ...
  const cleanDalil = sanitizeTheologicalRespect(enrichUnfamiliarQuranicTerms(params.quoteText
    .replace(/(^|\n)\s*(?:\(\d+\)|\[\d+\]|\d+\.|\*|-|•)\s*/g, "$1")
  ...
  if (explanation) {
    const cleanExpl = sanitizeTheologicalRespect(enrichUnfamiliarQuranicTerms(stripScholarAttribution(explanation)));
    blocks.push(`Обяснение: ${cleanExpl}`);
  }

  // Note: In the video narration there is NO "Действие" (Action step) - per user instruction, the video ends cleanly with the explanation
  if (params.includeActionInVideo && sw?.actionStep?.trim()) {
    const cleanAct = sanitizeTheologicalRespect(cleanScriptPrefixes(sw.actionStep));
...
export const VIRAL_HADITH_SERIES_PRESETS = [
  ...
  },
  {
    collection: "bukhari",
    number: 5645,
    title: "Сахих ал-Бухари #5645 (Изпитанията)",
...
export const startBackgroundBatchGeneration = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data: { proposals } }) => {
    ...
    const batchMsg = {
      role: "assistant",
      text: `🎬 **Одобрено! Стартирах фоновото генериране на ${proposals.length} видеа от Вашия план!**\n\nВсички те са записани в устойчивия фонов енджин и се предават към облачната опашка за последователно рендиране. Можете веднага да затворите браузъра (дори на iPhone) — видеата се генерират автономно! Следете напредъка и ги изтеглете в раздел **[Изтегляния](/downloads)**.`,
    };
