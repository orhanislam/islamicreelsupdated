...
- Хадиси само сахих, ако не си 100% сигурен — НЕ предлагай хадис, предложи аят. ВАЖНО: Винаги включвай точния номер на хадиса (например "Bukhari 543", "Muslim 12"). Никога не връщай само името на колекцията.
