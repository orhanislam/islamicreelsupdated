...
Style: Reference,Outfit,70,&H005DC9F4,&H000000FF,&H00000000,&H80000000,-1,0,0,0,100,100,0,0,3,6,0,8,50,50,150,1
...
`;
      ...
      if (data.reference) {
        ass += `Dialogue: 0,0:00:00.00,${formatTime(audioDur)},Reference,,0,0,0,,{\\an8\\pos(540,150)\\blur4}${data.reference}\n`;
      }
