...
1. Жени (никакви жени, независимо от облеклото или контекста).
2. Мъже без бради (ако има мъже, те ЗАДЪЛЖИТЕЛНО трябва да имат брада).
...
6. Музикални инструменти, танци, алкохол, наркотици, насилие, кучета, прасета.

Отговори САМО с 'HARAM' (ако има ДОРИ ЕДНО от изброените неща в ДОРИ ЕДИН от кадрите) или 'HALAL' (ако ВСИЧКИ кадри са напълно безопасни - напр. природа, абстракция, ислямска архитектура, мъже с бради). Няма нужда от обяснения.`;
